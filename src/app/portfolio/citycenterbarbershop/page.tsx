...
export default function CityCenterBarbershopCaseStudyPage() {
    ...
    <div className="min-h-screen bg-black text-white">
            ...
            <div className="relative bg-black/40 border border-white/10 rounded-3xl overflow-hidden">
              <div className="relative w-full aspect-[16/10]">
                <Image
                  ...
                  alt="City Center Barbershop interior"
                  fill
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-black/40 border border-white/10 rounded-2xl p-6">
              ...
              <p className="text-gray-400 text-sm">Poor search visibility and no strategic approach to local SEO or paid advertising.</p>
            </div>
            <div className="bg-black/40 border border-white/10 rounded-2xl p-6">
      ...
      <section className="py-14 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black/80 via-gray-900/60 to-black/40">
        <div className="max-w-7xl mx-auto">
          <div className="text-center sm:text-left mb-8">
            ...
            <h3 className="text-3xl font-semibold">Strategic local SEO + precision-targeted advertising</h3>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Local SEO Strategy */}
            <div className="bg-black/40 border border-white/10 rounded-2xl p-6">
              <h4 className="text-xl font-semibold mb-3">Local SEO Optimization</h4>
      ...
      <section className="py-14 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black via-gray-900 to-black">
        <div className="max-w-7xl mx-auto">
          <div className="text-center sm:text-left mb-8">
            ...
            <h3 className="text-3xl font-semibold">Record-breaking performance in the Netherlands</h3>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
              <div className="text-2xl md:text-3xl font-bold text-white">16K</div>
              <div className="text-gray-400 text-xs">Monthly Visitors</div>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
              <div className="text-2xl md:text-3xl font-bold text-white">€0.23</div>
              <div className="text-gray-400 text-xs">Lowest CPC in NL</div>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
              <div className="text-2xl md:text-3xl font-bold text-white">+340%</div>
              <div className="text-gray-400 text-xs">Organic Traffic</div>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
              <div className="text-2xl md:text-3xl font-bold text-white">89%</div>
              <div className="text-gray-400 text-xs">Booking Rate</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black via-gray-900 to-black">
        <div className="max-w-7xl mx-auto text-center">
          <h3 className="text-2xl sm:text-3xl font-semibold text-white mb-4">Ready to dominate your local market?</h3>
          <p className="text-gray-300 max-w-2xl mx-auto mb-6">See how we drive growth for local businesses, or get a personalized plan for your goals.</p>
