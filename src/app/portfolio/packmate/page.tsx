...
export default function PackmateCaseStudyPage() {
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="pt-28 pb-6 sm:pb-10 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black via-gray-900 to-black">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-3">
            Packmate: Innovative Packaging Solutions
          </h1>
          <p className="text-gray-300 text-lg max-w-3xl">
            Our agency partnered with Packmate, a leading carton box manufacturer, to elevate their digital presence through strategic social media management and high‑performing paid social campaigns.
          </p>
        </div>
      </header>
      ...
      <section className="pb-14 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black/60 via-gray-900/40 to-black/40">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative order-last lg:order-first">
            ...
            <div className="relative bg-black/40 border border-white/10 rounded-3xl overflow-hidden">
              <div className="relative w-full aspect-[16/10]">
                <Image
                  src="https://packmateindustries.com/assets/storage-a7be23a8.jpg"
                  alt="Packmate custom carton design"
                  fill
          ...
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl font-semibold mb-4">Elevating visibility and demand through strategic social media</h2>
            <p className="text-gray-300 leading-relaxed">
              Packmate sought to expand brand awareness and generate qualified B2B inquiries. We established a clear content architecture, modernized visual standards, and launched targeted paid social campaigns to reach procurement teams and operations managers in key markets.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-14 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black via-gray-900 to-black">
        <div className="max-w-7xl mx-auto">
          <div className="text-center sm:text-left mb-8">
            ...
            <h3 className="text-3xl font-semibold">Reaching industrial buyers with a clear value proposition</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-black/40 border border-white/10 rounded-2xl p-6">
              <h4 className="text-white font-semibold mb-2">Low brand visibility</h4>
              <p className="text-gray-400 text-sm">Limited organic presence and inconsistent messaging across platforms.</p>
            </div>
            <div className="bg-black/40 border border-white/10 rounded-2xl p-6">
              <h4 className="text-white font-semibold mb-2">Unclear content structure</h4>
              <p className="text-gray-400 text-sm">Product strengths weren’t mapped to buyer needs or decision stages.</p>
            </div>
            <div className="bg-black/40 border border-white/10 rounded-2xl p-6">
              <h4 className="text-white font-semibold mb-2">Inefficient ad spend</h4>
              <p className="text-gray-400 text-sm">Previous campaigns lacked segmentation, creative testing, and conversion goals.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-14 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black/80 via-gray-900/60 to-black/40">
        <div className="max-w-7xl mx-auto">
          <div className="text-center sm:text-left mb-8">
            ...
            <h3 className="text-3xl font-semibold">A balanced system of content, community, and paid growth</h3>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-black/40 border border-white/10 rounded-2xl p-6">
              ...
              <ul className="space-y-2 text-gray-300 text-sm leading-relaxed">
                <li><span className="text-white/80 font-medium">Content strategy:</span> Monthly content pillars (product features, quality control, sustainability, client stories).</li>
                <li><span className="text-white/80 font-medium">Design system:</span> Consistent visual templates aligned to brand palette and typography.</li>
                <li><span className="text-white/80 font-medium">Community:</span> Proactive replies, supplier partnerships, and industry hashtags to broaden reach.</li>
                <li><span className="text-white/80 font-medium">Platforms:</span> LinkedIn for B2B decision-makers, Instagram for visual storytelling, Facebook for regional reach.</li>
              </ul>
            </div>

            {/* Social Media Advertising */}
            <div className="bg-black/40 border border-white/10 rounded-2xl p-6">
              <h4 className="text-xl font-semibold mb-3">Social Media Advertising</h4>
              <ul className="space-y-2 text-gray-300 text-sm leading-relaxed">
                <li><span className="text-white/80 font-medium">Targeting:</span> Job titles (Procurement, Operations), interests (logistics, manufacturing), lookalikes from site traffic.</li>
                <li><span className="text-white/80 font-medium">Objectives:</span> Split between lead generation (instant forms) and awareness (video + carousel).</li>
                <li><span className="text-white/80 font-medium">Creative testing:</span> A/B/C tests across value props (durability, cost‑efficiency, custom sizing) and formats.</li>
                <li><span className="text-white/80 font-medium">Optimization:</span> Weekly budget rebalancing, frequency control, and conversion guardrails.</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="py-14 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black via-gray-900 to-black">
        <div className="max-w-7xl mx-auto">
          <div className="text-center sm:text-left mb-8">
            ...
            <h3 className="text-3xl font-semibold">Measurable growth in awareness and lead quality</h3>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
              <div className="text-2xl md:text-3xl font-bold text-white">+240%</div>
              <div className="text-gray-400 text-xs">Social Reach</div>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
              <div className="text-2xl md:text-3xl font-bold text-white">-38%</div>
              <div className="text-gray-400 text-xs">CPL (Lead Forms)</div>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
              <div className="text-2xl md:text-3xl font-bold text-white">+4.1x</div>
              <div className="text-gray-400 text-xs">Ad ROAS (Modelled)</div>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
          ...
          <div className="relative">
            ...
            <blockquote className="relative bg-black/40 border border-white/10 rounded-3xl p-8 text-gray-300">
              <p className="text-lg leading-relaxed">
                “Clearview’s team transformed our social presence. Their content system and paid strategy consistently bring in qualified inquiries we weren’t reaching before.”
              </p>
              <footer className="mt-4 text-sm text-white/80">Marketing Manager, Packmate</footer>
            </blockquote>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black via-gray-900 to-black">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto mb-6">See how we drive growth for manufacturers, or get a personalized plan for your goals.</p>
